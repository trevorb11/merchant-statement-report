  ...
  const html = `
    ...
    <body>
      ...
      <div class="footer">
        ...
        <p style="font-size: 10px; margin-top: 10px; color: #666;">Disclaimer: This is not financial advice. The analysis provided is for informational purposes only.</p>
      </div>
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="relative z-10">
        ...
        <footer className="border-t border-white/5 py-8">
          <div className="max-w-5xl mx-auto px-6 text-center text-sm text-slate-500 space-y-2">
            <p>&copy; 2026 Today Capital Group. All rights reserved.</p>
            <p className="text-xs text-slate-600">This is not financial advice. The analysis provided is for informational purposes only.</p>
          </div>
        </footer>
      </main>
    </div>
    ...
    <div className="space-y-8">
      ...
      {activeTab === 'fundability' && (
        <div className="space-y-6">
          ...
          {/* Disclaimer */}
          <div className={`mt-6 p-4 rounded-lg text-center ${isDark ? 'bg-slate-800/50 border border-white/10' : 'bg-slate-100 border border-slate-200'}`}>
            <p className={`text-xs ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
              <strong>Disclaimer:</strong> This is not financial advice. The analysis and recommendations provided are for informational purposes only and should not be considered as professional financial, investment, or legal advice. Please consult with qualified professionals before making any financial decisions.
            </p>
          </div>
        </div>
      )}
